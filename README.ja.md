...
この「閾値」こそが正直な見出しであり、「勝った反応の数」ではない。
これは、各反応の判定が成り立たなくなる、化学プラント側の溶媒回収率で
ある。そして——**判定が確定した256件のうち、回収率99%に耐えられる
ものは1件もなかった。** 実際の工業的な蒸留による溶媒回収率は90〜95%で
ある。つまり結論は「酵素が256回勝った」ではなく、**「この反応クラスに
おいて、酵素の優位性は確かに実在するが限定的であり、工業的な溶媒
リサイクルの前では消えてしまう」**ということだ。これは反証可能な主張
であり、単なる宣伝文句ではない。
...
なければ、残り262件の結果は自分自身のテンプレートをなぞって報告して
